...
func start_sword_hit():
	...
	position_sword_hitbox()

	hitbox.monitoring = true
	
	# CRITICAL: We need to wait for the physics engine to update 
	# now that the hitbox has moved and turned on.
